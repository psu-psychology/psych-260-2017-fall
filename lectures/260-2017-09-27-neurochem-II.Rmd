---
title: "260-2017-09-27-neurochem-II"
author: "Rick Gilmore"
date: "`r Sys.time()`"
...
## If the equilibrium potential for $Cl^-$ is -75 mV and the membrane potential at rest is -70 mV, what will happen to $Cl^-$ ions when a GABA-A channel opens?

- Nothing
- $Cl^-$ will flow out, deppolarizing the neuron
- $Cl^-$ will flow in, hyperpolarizing the neuron
- $Cl^-$ will flow in, depolarizing the neuron

## If the equilibrium potential for $Cl^-$ is -75 mV and the membrane potential at rest is -70 mV, what will happen to $Cl^-$ ions when a GABA-A channel opens?

- Nothing
- $Cl^-$ will flow out, deppolarizing the neuron
- <span class="red">$Cl^-$ will flow in, hyperpolarizing the neuron</span>
- $Cl^-$ will flow in, depolarizing the neuron
