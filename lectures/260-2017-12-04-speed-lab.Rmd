---
title: "260-2017-12-04-speed-lab"
author: PSYCH 260H.002
date: "`r Sys.time()`"
...
- [Prior evidence](https://psu-psychology.github.io/psych-260-spring-2017/lecture-notes/260-2017-03-29-somatosensation.html#15). [Last spring's data](https://psu-psychology.github.io/psych-260-spring-2017/lecture-notes/260-2017-04-24-speed-lab.html#18)
...
- Data file with [body measurements](https://docs.google.com/spreadsheets/d/1OVPplJvtiLbGqLdv86EbZjEvLu41X_ggslVvDXDfdIA/edit#gid=0)
    + participant, ankleshoulder (cm)
- Data file with [reaction times](https://docs.google.com/spreadsheets/d/1OVPplJvtiLbGqLdv86EbZjEvLu41X_ggslVvDXDfdIA/edit#gid=1626241513)
...
This document was prepared in RStudio 1.1.383 on `r Sys.time()`.
